    ...
    const fetchToken = async () => {
      try {
        ...
        const response = await fetch('https://accounts.spotify.com/api/token', {
          ...
          body: 'grant_type=client_credentials&client_id=e2f528a7ccdf44d78560cebedee7454e&client_secret=78589cf346844badb6484ec157ec0d3d',
        });
          ...
          {hasSearched && tracks.length > 0 ? (
            ...
            !hasSearched && (
              <div className="col-12 py-5 text-center">
                ...
                <br />
                <img
                  src="https://res.cloudinary.com/dygivmpuq/image/upload/v1735207061/music_player_gt4obq.avif"
                  alt="MUZZ"
